...
- [lock Callouts in edit mode](text%20editor/lock%20Callouts%20in%20edit%20mode.md)
- Own invisible callouts
	- [no_invisible Callout](text%20editor/no_invisible%20Callout.md)
	- [not_simpleCallout](text%20editor/not_simpleCallout.md)
	- Right side
...
-  wip: [Checkboxes - Progress bar checkboxes](custom%20CSS/text%20editor/Checkboxes%20-%20Progress%20bar%20checkboxes.md)
	- wip: [Checkboxes - Priority checkboxes](text%20editor/Checkboxes%20-%20Priority%20checkboxes.md)
- wip: [Mermaid DarkandLight Theme CSS snippet - adding contrast, providing template](text%20editor/Mermaid%20DarkandLight%20Theme%20CSS%20snippet%20-%20adding%20contrast,%20providing%20template.md)
- wip: [slrvb teheme](https://publish.obsidian.md/slrvb-docs/ITS+Theme/Callouts/Callout+-+Columns)
